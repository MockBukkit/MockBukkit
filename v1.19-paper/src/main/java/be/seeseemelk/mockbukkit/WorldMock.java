...
public abstract class WorldMock implements World
{
	public final MockWorld target;

	public static @NotNull WorldMock create()
	{
		return MockFactory.createProxy(BukkitObjectProvider.INSTANCE, WorldMock.class, new MockWorld());
	}

	public static @NotNull WorldMock create(@NotNull WorldCreator creator)
	{
		throw new UnimplementedOperationException();
	}

	public static @NotNull WorldMock create(@NotNull Material material, int height)
	{
		MockMaterial mockMaterial = MockMaterial.valueOf(material.name());
		return MockFactory.createProxy(BukkitObjectProvider.INSTANCE, WorldMock.class, new MockWorld(mockMaterial, height));
	}

	public static WorldMock create(Material grassBlock, Biome jungle, int i, int i1)
	{
		throw new UnimplementedOperationException();
	}

	public static WorldMock create(Material dirt, Biome badlands, int i, int i1, int i2)
	{
		throw new UnimplementedOperationException();
	}

	public static WorldMock create(Material dirt, int i, int i1, int i2)
	{
		throw new UnimplementedOperationException();
	}
	...
	@Override
	public abstract @NotNull ChunkMock getChunkAt(int x, int z);

	@Override
	public abstract @NotNull BlockMock getBlockAt(int x, int y, int z);

	public abstract @NotNull BlockMock getBlockAt(Coordinate coordinate);

	public abstract @NotNull ChunkMock getChunkAt(@NotNull ChunkCoordinate coordinate);
...
//		if (chunk == null)
//		{
//			chunk = ChunkMock.create(coordinate.getX(), coordinate.getZ());

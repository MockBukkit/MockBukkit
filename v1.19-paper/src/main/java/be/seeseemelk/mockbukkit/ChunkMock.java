...
public abstract class ChunkMock implements Chunk
{
	public final MockChunk target;
	...
	public static @NotNull ChunkMock create(@NonNull WorldMock world, int x, int z)
	{
		return MockFactory.createProxy(BukkitObjectProvider.INSTANCE, ChunkMock.class, new MockChunk(world.target, x, z));
	}
}

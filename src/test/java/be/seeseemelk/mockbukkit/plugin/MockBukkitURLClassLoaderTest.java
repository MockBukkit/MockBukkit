...
class MockBukkitURLClassLoaderTest
{
	...
	void getConfiguration()
	{
		...
		assertEquals("be.seeseemelk.testplugin.TestPlugin", meta.getMainClass());
	}

	@Test
	void loadClass_exists()
	{
		assertDoesNotThrow(() -> urlClassLoader.loadClass("be.seeseemelk.testplugin.TestPlugin"));
	}
	...
	{
		assertDoesNotThrow(() -> urlClassLoader.loadClass("be.seeseemelk.mockbukkit.MockBukkit"));
	}

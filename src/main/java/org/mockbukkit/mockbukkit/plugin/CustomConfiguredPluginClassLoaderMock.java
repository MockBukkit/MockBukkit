...
public class CustomConfiguredPluginClassLoaderMock extends ClassLoader implements ConfiguredPluginClassLoader
{
	...
	public void createCustomClass()
	{
		...
		MethodVisitor mv = cw.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_STATIC, "testMethod", "(Lorg/mockbukkit/mockbukkit/TestPlugin;)V", null, null);
		mv.visitVarInsn(Opcodes.ALOAD, 0);
		mv.visitInsn(Opcodes.ICONST_1);
		mv.visitFieldInsn(Opcodes.PUTFIELD, "org/mockbukkit/mockbukkit/TestPlugin", "classLoadSucceed", "Z");

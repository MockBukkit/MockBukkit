...
/**
 * This is a Mock of the {@link PersistentDataContainer} interface to allow the "persistent"
 * storage of data. Only that it isn't persistent of course since it only ever exists in a
 * test environment.
 * 

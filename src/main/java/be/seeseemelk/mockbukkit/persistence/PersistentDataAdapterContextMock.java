...
/**
 * This is about as basic of an implementation for {@link PersistentDataAdapterContext} as
 * you could imagine. But it is identical with the default CraftBukkit implementation too.
 * So mock successful I would say.
 * 
